...
import type { WalletSettings } from '../vega-file-storage-provider.js';

export const applyWalletSettingsToExchangeLab = (exlab: cauldron.ExchangeLab, settings: WalletSettings) => {
