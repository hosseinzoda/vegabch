...
export default class Moria1RepayLoan extends VegaCommand<typeof Moria1RepayLoan> {
  static args = {
  ...
  async run (): Promise<any> {
    ...
    const result = await this.callModuleMethod('moria1.repay-loan', wallet_name, loan_outpoint, { broadcast, txfee_per_byte, verify: true });
    this.log('Summary:');
    ...
    return {
      ...
      ...Object.fromEntries([
        'moria_utxo', 'delphi_utxo', 'loan_agent_utxo',
