...
export default class Moria1LiquidateLoan extends VegaCommand<typeof Moria1LiquidateLoan> {
  static args = {
  ...
  async run (): Promise<any> {
    ...
    const result = await this.callModuleMethod('moria1.liquidate-loan', wallet_name, loan_outpoint, { broadcast, txfee_per_byte, verify: true });
    this.log('Summary:');
